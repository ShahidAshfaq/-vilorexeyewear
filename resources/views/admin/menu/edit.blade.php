                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="frame" class="form-select">
                                ...
                                <option value="Rimless" {{ old('frame', $product->frame) == 'Rimless' ? 'selected' : '' }}>
                                    Rimless
                                </option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="lens" class="form-select">
                                ...
                                <option value="Blue Cut" {{ old('lens', $product->lens) == 'Blue Cut' ? 'selected' : '' }}>
                                    Blue Cut
                                </option>
                                ...
                                <option value="No Power" {{ old('lens', $product->lens) == 'No Power' ? 'selected' : '' }}>
                                    No Power
                                </option>
                        ...
                        @if ($images)
                            @foreach ($images as $image)
                                <div class="border rounded-3 p-1">
                                    ...
                                    <img src="{{ asset('/storage/app/public/' . $image) }}" width="120"
                                        height="120" class="rounded-2" style="object-fit:cover;"
                                        alt="{{ $product->title }}">
