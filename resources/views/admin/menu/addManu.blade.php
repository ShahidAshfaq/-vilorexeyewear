            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="sku" class="form-control" placeholder="RB-1001"
                ...
                <select name="brand_id" class="form-select">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="frame" class="form-select">
                            ...
                            <option value="Full Rim" {{ old('frame') == 'Full Rim' ? 'selected' : '' }}>
                                Full Rim
                            </option>

                            <option value="Half Rim" {{ old('frame') == 'Half Rim' ? 'selected' : '' }}>
                                Half Rim
                            </option>

                            <option value="Rimless" {{ old('frame') == 'Rimless' ? 'selected' : '' }}>
                                Rimless
                            </option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="lens" class="form-select">
                            ...
                            <option value="Single Vision" {{ old('lens') == 'Single Vision' ? 'selected' : '' }}>
                                Single Vision
                            </option>

                            <option value="Blue Cut" {{ old('lens') == 'Blue Cut' ? 'selected' : '' }}>
                                Blue Cut
                            </option>

                            <option value="Progressive" {{ old('lens') == 'Progressive' ? 'selected' : '' }}>
                                Progressive
                            </option>

                            <option value="Sunglasses" {{ old('lens') == 'Sunglasses' ? 'selected' : '' }}>
                                Sunglasses
                            </option>

                            <option value="No Power" {{ old('lens') == 'No Power' ? 'selected' : '' }}>
                                No Power
                            </option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" name="on_sale" value="1" class="form-check-input" id="on_sale"
                                {{ old('on_sale') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="trending" class="form-select">
                            ...
                            <option value="0" {{ old('trending', 0) == 0 ? 'selected' : '' }}>
                                No
                            </option>

                            <option value="1" {{ old('trending', 0) == 1 ? 'selected' : '' }}>
                                Yes
                            </option>
